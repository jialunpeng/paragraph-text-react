...
import './index.less';
import { LinkTextProps, ParagraphTextProps, SpanTextProps } from './interface';
...
const ParagraphText: React.FC<ParagraphTextProps> = (props) => {
  ...
  const debouncedWidth = useCallback(debounce(handleWidth, 600), [handleWidth]);
  ...
  const paragraphCls = classNames(`paragraph-text ${className || ''}`, {
    hidden: ellipsis,
  });
  ...
  return (
    <div className={paragraphCls} style={style}>
...
type ParagraphTextComponentType = typeof ParagraphText & {
  MentionLink: typeof MentionLink;
};

const ParagraphTextComponent = ParagraphText as ParagraphTextComponentType;
ParagraphTextComponent.MentionLink = MentionLink;
